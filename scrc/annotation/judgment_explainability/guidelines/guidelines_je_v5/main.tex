...
Another example of a neutral part of the facts are the section indicators labeled with capital letters (e.g. \epmh{A., B., A.a., A.b and so on}). Note that witnesses, accused persons and other involved parties are also labeled with uppercase letters and should be annotated if part of a sentence (see \ref{uppercase} below as illustration).
\begin{figure}[H]
