...
if __name__ == '__main__':
    ...
    court_composition_extractor.processed_file_path = court_composition_extractor.data_dir / "spiders_personal_information_extracted.txt"
    court_composition_extractor.loggerInfo = {
