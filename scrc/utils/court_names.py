...
# get issue_courts: all without any argument, or with index 0 or 1
def get_issue_courts(index=-1):
    issue_courts = [court_issue0, court_issue1]
    if index == -1:
        return court_issue0 + court_issue1
    return issue_courts[index]
...
court_error3 = ['AG_XX', 'AI_BZG', 'AR_RR', 'AR_SRK', 'AR_VB', 'AR_XX', 'BE_XX', 'BL_XX', 'BS_XX', 'CH_XX', 'FR_TAMA',
...
# get error_courts: all without any argument, or with index 0, 1, 2, 3
